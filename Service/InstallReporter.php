<?php
/**
 * Standalone install + heartbeat reporter for Panth_RobotsSeo.
 *
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_RobotsSeo';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-robots-seo';
